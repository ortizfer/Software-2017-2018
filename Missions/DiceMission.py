...
def check_pair():
    if visionlist[4] is not None and visionlist[5] is not None:
        Dice1.set_centx(visionlist[4].getcentx()) #update for vision
        Dice1.set_centy(visionlist[4].getcenty())  # update for vision
        Dice1.set_value(5)
        Dice1.set_boundingbox(visionlist[4].getbounding) #needs update
        Dice2.set_centx(visionlist[5].getcentx())  # update for vision
        Dice2.set_centy(visionlist[5].getcenty())  # update for vision
        Dice2.set_value(6)
        Dice2.set_boundingbox(visionlist[5].getbounding)  # needs update
        return 11
    elif visionlist[5] is not None and visionlist[0]is not None:
        Dice1.set_centx(visionlist[0].getcentx())  # update for vision
        Dice1.set_centy(visionlist[0].getcenty())  # update for vision
        Dice1.set_value(1)
        ...
        Dice1.set_value(5)
        Dice1.set_boundingbox(visionlist[4].getbounding)  # needs update
        Dice2.set_centx(visionlist[1].getcentx())  # update for vision
        Dice2.set_centy(visionlist[1].getcenty())  # update for vision
        Dice2.set_value(2)
        Dice2.set_boundingbox(visionlist[1].getbounding)  # needs update
        return 7
    elif visionlist[2] is not None and visionlist[3] is not None:
        Dice1.set_centx(visionlist[2].getcentx())  # update for vision
        Dice1.set_centy(visionlist[2].getcenty())  # update for vision
        Dice1.set_value(3)
        Dice1.set_boundingbox(visionlist[2].getbounding)  # needs update
        Dice2.set_centx(visionlist[3].getcentx())  # update for vision
        Dice2.set_centy(visionlist[3].getcenty())  # update for vision
        Dice2.set_value(4)
